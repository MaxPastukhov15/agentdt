...
from core.tools import (search_chemistry_collection, search_arxiv, 
                        create_summary, search_duckduckgo)
...
async def test_create_summary_metadata_combinations(mock_chain_ainvoke):
    ...
    test_cases = [
        ...
        ({"title": "Paper", "link": "http://example.com"}, "Paper, http://example.com", "Title: Paper"),
        ({}, "N/A", "Title: N/A"),
    ]
...
async def test_search_arxiv_success(mock_chain_ainvoke):
    ...
    with patch("core.tools.ArxivRetriever") as MockRetriever:
        ...
        test_docs = [Document(page_content="DFT study", metadata={"title": "DFT Paper", "authors": "Lee", "link": "arxiv:1234"})]
